...
// codelet-core::persistence::messages. Living in `rust/core/tests/`
...
fn compute_hash_produces_known_sha256_from_core() {
    ...
    // The NAPI re-export shim test (in rust/napi/tests/) asserts that
...
// ============================================================================
//
// This is a compile-time invariant: this test file is in `rust/core/tests/`
