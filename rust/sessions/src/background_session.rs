...
//!
//! Moved here by **RPC-039** from `rust/napi/src/session_manager.rs`
...
//!   `rust/napi/src/session_manager.rs`) maps the new string error
...
// re-exports declared at the top of rust/napi/src/session_manager.rs.
...
/// `rust/napi/src/session_manager.rs` reads `prompt_input.input` and
...
impl BackgroundSession {
    ...
    /// agent-loop twins (rust/napi/src/agent_loop.rs and
    /// rust/agent-loop/src/agent_loop.rs) for every real dispatched user
