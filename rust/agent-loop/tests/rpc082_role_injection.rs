...
//! (`rust/napi/src/agent_loop.rs:91-96`) reads `session.get_role()`
...
fn openai_inlined_arm_reads_session_role_and_passes_as_preamble() {
    // @step Given the source file rust/agent-loop/src/agent_loop.rs
...
// `rust/agent-loop/src/dispatch.rs::copilot_create_rig_agent_signature_matches_dispatch_macro_contract`.
