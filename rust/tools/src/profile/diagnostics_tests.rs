...
fn inlined_frame(outermost: &str, inner_a: &str, inner_b: &str, inner_c: &str) -> Vec<FrameInfo> {
    vec![
        FrameInfo {
            ...
            file: Some("rust/tools/src/bridge_relay.rs".to_string()),
            line: Some(42),
        },
        FrameInfo {
    ...
    let stack = SampleStack {
        ...
        frames: vec![
            ...
            rust_frame(
                ...
                "rust/napi/src/agent_manager_handler.rs",
                243,
            ),
            rust_frame(
    ...
    let stacks = vec![
        SampleStack {
            ...
            frames: vec![rust_frame(
                ...
                "rust/tools/src/bridge_relay.rs",
                100,
            )],
            count: 500,
        },
        SampleStack {
            ...
            frames: vec![rust_frame(
                ...
                "rust/cli/src/interactive/stream_loop.rs",
                200,
            )],
            count: 300,
        },
        SampleStack {
            ...
            frames: vec![rust_frame(
                ...
                "rust/core/src/session_manager.rs",
                50,
            )],
            count: 100,
        },
