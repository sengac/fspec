...
//! | Method                  | Consumer                                                          |
//! |-------------------------|-------------------------------------------------------------------|
//! | `client()`              | `rust/napi/src/deep_search_handler.rs` `build_and_run!` macro  |
//! | `create_rig_agent(...)` | `rust/napi/src/session_manager.rs` `run_with_provider!` macro  |
//!
...
fn client_accessor_supports_building_an_agent_builder_with_the_providers_model_name() {
    ...
    // macro at rust/napi/src/deep_search_handler.rs:258.
