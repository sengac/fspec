...
2. Matches rust's behavior for macOS users
...
**Rationale**:
1. Matches rust's default behavior
...
- `/home/rquast/projects/rust/src/agent/codex-provider.ts` - Provider implementation
- `/home/rquast/projects/rust/src/agent/codex-auth.ts` - Authentication flow
- `/home/rquast/projects/rust/spec/features/multi-provider-llm-support-with-dynamic-switching.feature` - Feature spec

### Code References (codelet Rust)
- `/home/rquast/projects/rust/src/providers/claude.rs` - Pattern to follow
- `/home/rquast/projects/rust/src/providers/openai.rs` - Pattern to follow (closest match)
- `/home/rquast/projects/rust/src/providers/mod.rs` - LlmProvider trait
