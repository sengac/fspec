...
### Key Files to Study:
- `~/projects/rust/src/agent/provider-manager.ts` - Main ProviderManager class
- `~/projects/rust/src/agent/codex-provider.ts` - Codex provider integration
- `~/projects/rust/src/agent/claude-provider.ts` - Claude Code OAuth integration
- `~/projects/rust/src/agent/runner.ts` - How runner uses ProviderManager
