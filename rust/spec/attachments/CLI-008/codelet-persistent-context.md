...
The primary context storage is in `/home/rquast/projects/rust/src/agent/runner.ts`:
...
Location: `/home/rquast/projects/rust/src/agent/system-reminders.ts`
...
Location: `/home/rquast/projects/rust/src/agent/context.ts`
...
Location: `/home/rquast/projects/rust/src/agent/token-state-manager.ts`
...
Location: `/home/rquast/projects/rust/src/agent/compaction.ts` and `anchor-point-compaction.ts`
...
The elegance of rust's design is its simplicity: everything is in RAM, there's a single loop, and context survives because the function never returns until the user exits.
