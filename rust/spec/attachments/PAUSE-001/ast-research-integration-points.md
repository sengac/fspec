...
|------|-------------|-------------|
| `rust/tools/src/tool_pause.rs` | NEW | Core pause mechanism with Condvar |
| `rust/tools/src/lib.rs` | MODIFY | Export tool_pause module |
| `rust/napi/src/session_manager.rs` | MODIFY | Add Paused status, pause_state field |
| `rust/napi/src/tool_pause.rs` | NEW | NAPI bindings for pause functions |
| `rust/napi/src/lib.rs` | MODIFY | Export tool_pause bindings |
| `rust/common/src/web_search.rs` | MODIFY | Add pause field to action variants |
| `rust/tools/src/web_search.rs` | MODIFY | Call pause_for_user when pause=true |
