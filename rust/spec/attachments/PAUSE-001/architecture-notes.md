...
| File | Purpose |
|------|---------|
| `rust/napi/src/session_manager.rs` | `SessionStatus` enum, status getters/setters |
| `rust/tools/src/tool_progress.rs` | Global callback for streaming tool output |
| `rust/tools/src/web_search.rs` | `WebSearchTool` implementation |
| `rust/common/src/web_search.rs` | `WebSearchAction` enum (shared types) |
...
**File: `rust/tools/src/tool_pause.rs`** (NEW)
...
**File: `rust/napi/src/tool_pause.rs`** (NEW)
...
**File: `rust/common/src/web_search.rs`** (MODIFY)
