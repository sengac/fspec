...
- `/home/rquast/projects/rust/src/agent/anchor-point-compaction.ts` (lines 1-580)
- `/home/rquast/projects/rust/src/agent/runner.ts` (lines 829-949)
- `/home/rquast/projects/rust/src/agent/token-tracker.ts` (complete file)
- `/home/rquast/projects/rust/src/agent/llm-summary-provider.ts` (complete file)
...
- `/home/rquast/projects/rust/src/session/mod.rs` (complete file)
- `/home/rquast/projects/rust/src/agent/rig_agent.rs` (complete file)
- `/home/rquast/projects/rust/src/cli/interactive.rs` (lines 180-450)
...
1. **LLM Summary Quality**: Generated summaries may lose critical context.
   - **Mitigation**: Follow rust's prompt template exactly, test with real sessions.
...
2. **Message Reconstruction**: Direct port of rust's logic (well-tested).
