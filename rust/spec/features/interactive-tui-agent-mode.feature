...
Feature: Interactive TUI Agent Mode
  ...
  #
  # EXAMPLES:
  #   1. User runs 'rust' without arguments, sees startup card with 'Available models: Claude (/claude), OpenAI (/openai)', enters prompt
  ...
  Scenario: Start interactive mode and see startup card
    ...
    When I run 'rust' without any arguments
