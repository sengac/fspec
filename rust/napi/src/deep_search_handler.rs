...
pub async fn execute_deep_search(
    ...
    let graph_available =
        crate::graph::registry::is_graph_initialized(crate::graph::registry::LEARNINGS_GRAPH)
            || crate::graph::registry::is_graph_initialized(crate::graph::registry::AST_CODE_GRAPH);
