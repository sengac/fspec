...
fn test_graph_module_only_exports_dual_graph() {
    ...
    //
    // RPC-092: The graph module was lifted from rust/napi/src/graph/ to
    // rust/graph/src/ (peer workspace crate). rust/napi/src/graph.rs is
    ...
    assert!(
        ...
        "rust/napi/src/graph.rs shim should exist after RPC-092 lift"
    );
