...
// rust/napi/src/persistence/storage.rs and rust/napi/src/persistence/types.rs
...
fn napi_reexport_paths_route_through_core() {
    // @step Given rust/napi/src/persistence/storage.rs re-exports MessageStore and compute_hash from codelet_core::persistence::messages
    // @step And rust/napi/src/persistence/types.rs re-exports StoredMessage, MessageSource, and MessageRef from codelet_core::persistence::messages
