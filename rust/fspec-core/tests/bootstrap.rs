...
fn cli_and_dispatcher_converge_on_the_same_fspec_core_run_function() {
    ...
    // @step Then the CLI bridge module rust/fspec/src/bootstrap.rs contains no documentation-building or transform logic — its only computation is JSON arg marshalling
