...
fn shares_one_implementation_between_the_dispatcher_and_the_cli_bridge() {
    ...
    // @step When I inspect rust/fspec-core/src/commands/init.rs
    ...
    // @step Then the CLI bridge rust/fspec/src/init.rs delegates to init::run and contains no inline scaffolding or registry logic
