...
fn two_front_doors_same_function_serves_cli_and_dispatcher() {
    // @step Given rust/fspec-core/src/commands/query_work_units.rs exposes `pub async fn run(args_json: &str, project_root: &Path) -> Result<String, FspecCoreError>`
    ...
    // @step When I inspect rust/fspec/src/query_work_units.rs
