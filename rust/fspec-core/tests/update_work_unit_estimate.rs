...
fn dispatcher_is_the_single_source_of_truth_for_estimate() {
    ...
    // @step And I run `./rust/target/release/fspec update-work-unit-estimate TASK-001 3` in an identical workspace
    // (The CLI path is exercised by rust/fspec/tests/cli_update_work_unit_estimate.rs; here we assert the
