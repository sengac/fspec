...
```
spec/
├── CURSOR.md                    # This file - specification process guide
...
```xml
**⚠️ IMPORTANT:** PREFILL DETECTED in generated feature file.
...
✗ Failed to update estimate: **⚠️ IMPORTANT:** ACDD VIOLATION: Cannot estimate story work unit without completed feature file.
...
✗ Failed to update estimate: **⚠️ IMPORTANT:** ACDD VIOLATION: Cannot estimate work unit with incomplete feature file.
...
1. **NO Markdown-Based Specifications**
   ...
   - Exception: FOUNDATION.md, TAGS.md, and CURSOR.md are meta-documentation
...
- Blocking hook failures emit **⚠️ IMPORTANT:** blocks wrapping stderr
- This makes failures highly visible in Cursor
...
- Stderr wrapped in **⚠️ IMPORTANT:** blocks for AI visibility
...
```xml
**⚠️ IMPORTANT:** BLOCKING HOOK FAILURE: Virtual hook 'eslint' for AUTH-001 failed.
...
This makes failures **highly visible** to AI agents in Cursor, ensuring they address issues before continuing.
...
```xml
**⚠️ IMPORTANT:** CHECKPOINT CONFLICT RESOLUTION REQUIRED
