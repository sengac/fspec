...
```
spec/
├── AIDER.md                    # This file - specification process guide
...
1. **NO Markdown-Based Specifications**
   ...
   - Exception: FOUNDATION.md, TAGS.md, and AIDER.md are meta-documentation
...
- This makes failures highly visible in Aider
...
This makes failures **highly visible** to AI agents in Aider, ensuring they address issues before continuing.
