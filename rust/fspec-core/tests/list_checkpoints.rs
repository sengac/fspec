...
/// approach as rust/git/tests/common/mod.rs::setup_test_repo). gitoxide
...
fn shared_infrastructure_wiring_under_fspec_core() {
    ...
    // @step When I inspect rust/fspec-core/Cargo.toml
    ...
    // @step When I inspect rust/fspec-core/src/commands/list_checkpoints.rs
