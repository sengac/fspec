...
pub(crate) fn config_for(name: &str) -> Option<&'static CommandHelpConfig> {
    match name {
        ...
        "add-command-to-foundation" => {
            Some(&crate::help::configs::add_command_to_foundation::CONFIG)
        }
        ...
        "add-domain-event-to-foundation" => {
            Some(&crate::help::configs::add_domain_event_to_foundation::CONFIG)
        }
        ...
        "add-foundation-bounded-context" => {
            Some(&crate::help::configs::add_foundation_bounded_context::CONFIG)
        }
        ...
        "generate-example-mapping-from-event-storm" => {
            Some(&crate::help::configs::generate_example_mapping_from_event_storm::CONFIG)
        }
        ...
        "query-example-mapping-stats" => {
            Some(&crate::help::configs::query_example_mapping_stats::CONFIG)
        }
        ...
        "remove-aggregate-from-foundation" => {
            Some(&crate::help::configs::remove_aggregate_from_foundation::CONFIG)
        }
        ...
        "restore-architecture-note" => {
            Some(&crate::help::configs::restore_architecture_note::CONFIG)
        }
        ...
        "show-foundation-event-storm" => {
            Some(&crate::help::configs::show_foundation_event_storm::CONFIG)
        }
        ...
        "update-work-unit-estimate" => {
            Some(&crate::help::configs::update_work_unit_estimate::CONFIG)
        }
        ...
        "validate-foundation-schema" => {
            Some(&crate::help::configs::validate_foundation_schema::CONFIG)
        }
