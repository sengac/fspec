//! Logging module - Rust port of rust's Winston logging system
//!
...
///
/// This mirrors rust's Winston logging implementation:
...
pub fn init_logging(verbose: bool) -> Result<()> {
    ...
    let file_appender = rolling::daily(log_dir, "rust");
