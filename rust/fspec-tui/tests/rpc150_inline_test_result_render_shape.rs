...
//! `rust/fspec-tui/src/views/provider_settings/list_nav_render.rs`
...
fn scenario_render_nav_items_reads_view_test_result_inside_the_per_row_paint_loop() {
    // @step Given I read the source of rust/fspec-tui/src/views/provider_settings/list_nav_render.rs
...
fn scenario_paint_test_result_decoration_helper_is_owned_exclusively_by_list_nav_render_rs() {
    // @step Given I read the source of rust/fspec-tui/src/views/provider_settings/detail.rs
    let detail = detail_rs();

    // @step And I read the source of rust/fspec-tui/src/views/provider_settings/row_render.rs
