...
/// Scenario: New wire types live in rust/rpc-types/src/lib.rs
#[test]
fn wire_types_live_in_rpc_types_lib_rs() {
    // @step Given the file rust/rpc-types/src/lib.rs is compiled
    let source = read_at("rust/rpc-types/src/lib.rs");
...
fn provider_settings_view_module_exists() {
    ...
    // @step When rust/fspec-tui/src/views/provider_settings/mod.rs is read
    let source = read_at("rust/fspec-tui/src/views/provider_settings/mod.rs");
    ...
    let mode_source = read_at("rust/fspec-tui/src/views/provider_settings/mode.rs");
    ...
    // And rust/fspec-tui/src/views/mod.rs declares pub mod provider_settings
    let views_mod = read_at("rust/fspec-tui/src/views/mod.rs");
...
fn provider_settings_view_imports_canonical_helpers() {
    // @step Given rust/fspec-tui/src/views/provider_settings/mod.rs
    let source = read_at("rust/fspec-tui/src/views/provider_settings/mod.rs");
...
fn every_file_under_provider_settings_stays_under_300_lines() {
    // @step Given rust/fspec-tui/src/views/provider_settings/
    let dir = workspace_root().join("rust/fspec-tui/src/views/provider_settings");
...
fn components_mod_declares_confirm_delete_provider_credentials_action() {
    // @step Given rust/fspec-tui/src/components/mod.rs
    let source = read_at("rust/fspec-tui/src/components/mod.rs");
...
fn list_mode_routes_slash_to_filter_mode() {
    ...
    let list_source = read_at("rust/fspec-tui/src/views/provider_settings/list.rs");
...
fn rpc054_slash_command_action_enum_has_no_providers_variant() {
    ...
    let source = read_at("rust/fspec-tui/src/views/agent/slash_commands.rs");
...
fn rpc054_dispatch_slash_commands_has_no_providers_arm() {
    ...
    let source = read_at("rust/fspec-tui/src/app/dispatch_slash_commands.rs");
