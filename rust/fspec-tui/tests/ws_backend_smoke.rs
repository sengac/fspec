...
/// `rust/fspec-tui/src/transport/websocket.rs` to confirm the rule
...
fn websocket_backend_connect_uses_tokio_tungstenite_connect_async_directly() {
    // @step Given rust/fspec-tui/src/transport/websocket.rs exists
    ...
    // @step And no envelope, bincode, or framing code lives in rust/fspec-tui/src/transport/
    ...
    assert!(
        violations.is_empty(),
        "no envelope/bincode/framing code may live under rust/fspec-tui/src/transport/. \
