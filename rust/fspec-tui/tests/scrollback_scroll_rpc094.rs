...
fn rpc094_source_shape_every_touched_module_under_300_lines() {
    ...
    // @step Then every file under rust/fspec-tui/src/views/agent/ has at most 300 lines
    ...
    // @step And rust/fspec-tui/src/views/agent.rs has at most 300 lines
    ...
    // @step And rust/fspec-tui/src/components/mod.rs has at most 300 lines per-file-equivalent budget
    ...
    //   - RPC-364 added ≤30 lines (OpenCheckpointsView / CloseCheckpointsView /
    //     CheckpointsLoaded / LoadCheckpointFiles / CheckpointFilesLoaded /
    //     LoadCheckpointFileDiff / CheckpointFileDiffLoaded three-pane
    //     checkpoints variants + a 3-line group comment)
    //   - RPC-365 added ≤35 lines (RestoreCheckpointFile / RestoreCheckpointAll /
    //     RestoreCheckpointResult / RefreshCheckpointCounts restore variants
