...
//!
//! One-for-one port of rust's system-reminder system from:
...
///
/// Matches rust's constants from system-reminders.ts:25-32
...
///
/// Matches rust's createSystemReminder from context.ts:13-15
///
/// # Arguments
/// * `text` - Text to wrap
///
...
///
/// Matches rust's createSystemReminderContent from system-reminders.ts:37-42
///
/// # Arguments
...
///
/// Matches rust's extractTypeFromContent from system-reminders.ts:47-75
///
/// # Arguments
...
///
/// Matches rust's isSystemReminderOfType from system-reminders.ts:80-98
///
/// # Arguments
/// * `msg` - Message to check
...
///
/// Matches rust's countSystemRemindersByType from system-reminders.ts:103-108
///
/// # Arguments
