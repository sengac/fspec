...
fn test_output_mutator_source_files_are_removed() {
    ...
    // @step Then rust/cli/src/highlight.rs should not exist
    ...
    // @step Then rust/cli/src/diff.rs should not exist
    ...
    // @step Then rust/cli/src/lib.rs should not contain 'pub mod diff' or 'pub mod highlight'
...
fn test_tree_sitter_dependencies_removed() {
    ...
    // @step Then rust/Cargo.toml should not contain 'tree-sitter-highlight'
    ...
    // @step Then rust/Cargo.toml should not contain 'tree-sitter-bash'
    assert!(
        !workspace_cargo.contains("tree-sitter-bash"),
        "Workspace Cargo.toml should not contain tree-sitter-bash"
    );

    // @step Then rust/cli/Cargo.toml should not contain 'tree-sitter-highlight'
    ...
    // @step Then rust/cli/Cargo.toml should not contain 'tree-sitter-bash'
    assert!(
