...
//! of CMPCT-030:
//!   * `rust/cli/tests/gemini_continuation_compaction_test.rs` — asserted
//!     `"PromptCancelled".contains("PromptCancelled")` and `true == true`.
//!   * `rust/cli/tests/empty_turn_compaction_fix_test.rs` — reconstructed
...
fn gemini_continuation_calls_classify_compaction_branch_on_stream_error() {
    // @step Given the source file rust/cli/src/interactive/gemini_continuation.rs is readable
