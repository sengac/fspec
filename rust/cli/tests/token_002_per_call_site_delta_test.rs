...
//!
//!   * `rust/cli/src/interactive/stream_loop.rs` — main turn finalization
//!   * `rust/cli/src/interactive/gemini_continuation.rs` — normal completion
//!   * `rust/cli/src/interactive/gemini_continuation.rs` — `update_token_tracker` helper
//!
