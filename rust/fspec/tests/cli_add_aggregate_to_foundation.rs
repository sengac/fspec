...
fn scenario_clap_exposes_add_aggregate_to_foundation_in_help() {
    ...
    // @step When I run `./rust/target/release/fspec add-aggregate-to-foundation --help`
...
fn scenario_cli_adds_aggregate_and_prints_success_message() {
    ...
    // @step When I run `./rust/target/release/fspec add-aggregate-to-foundation Sales Order`
...
fn scenario_cli_persists_description_via_d_flag() {
    ...
    // @step When I run `./rust/target/release/fspec add-aggregate-to-foundation Billing Invoice -d "Billing root"`
...
fn scenario_cli_rejects_unknown_bounded_context_with_exit_1() {
    ...
    // @step When I run `./rust/target/release/fspec add-aggregate-to-foundation Unknown Order`
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And running `./rust/target/release/fspec add-aggregate-to-foundation Sales ViaCli` afterwards exits 0
    ...
    // @step And the CLI bridge module rust/fspec/src/add_aggregate_to_foundation.rs contains NO inline bounded-context lookup, ensure_foundation_file, or JSON-mutation logic — its only computation is JSON arg marshalling
    let bridge_path =
...
fn scenario_add_aggregate_to_foundation_help_matches_ts_reference() {
    ...
    // @step When I run `./rust/target/release/fspec add-aggregate-to-foundation --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("add-aggregate-to-foundation")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at rust/fspec/tests/fixtures/help/add-aggregate-to-foundation.txt
