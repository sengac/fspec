...
fn scenario_clap_exposes_remove_question_with_two_positional_args_in_help() {
    ...
    // @step When I run `./rust/target/release/fspec remove-question --help`
...
fn scenario_cli_removes_question_and_prints_success_line() {
    ...
    // @step When I run `./rust/target/release/fspec remove-question AUTH-001 0`
...
fn scenario_cli_rejects_unknown_question_id_with_exit_1_and_error_prefix() {
    ...
    // @step When I run `./rust/target/release/fspec remove-question AUTH-001 5`
...
fn scenario_cli_rejects_unknown_work_unit_with_exit_1_and_error_prefix() {
    ...
    // @step When I run `./rust/target/release/fspec remove-question AUTH-999 0`
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And running `./rust/target/release/fspec remove-question AUTH-001 1` afterwards exits 0
    ...
    // @step And the CLI bridge module rust/fspec/src/remove_question.rs contains NO inline state mutation or file-write logic — its only computation is JSON arg marshalling
...
fn scenario_remove_question_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./rust/target/release/fspec remove-question --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("remove-question")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at rust/fspec/tests/fixtures/help/remove-question.txt
