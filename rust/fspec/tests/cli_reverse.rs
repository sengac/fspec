...
//! `Mode::Reverse` in `rust/fspec/src/main.rs` and the ported
//! `rust/fspec-core/src/commands/reverse.rs`. Each scenario maps 1:1 to a
...
fn scenario_clap_exposes_reverse_with_byte_parity_help() {
    ...
    // @step Then stdout is byte-for-byte identical to the fixture at rust/fspec/tests/fixtures/help/reverse.txt
