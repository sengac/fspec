...
fn scenario_help_output_matches_ts_fixture() {
    ...
    // @step And the stdout matches the canonical help fixture at rust/fspec/tests/fixtures/help/remove-foundation-bounded-context.txt
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And the CLI bridge module rust/fspec/src/remove_foundation_bounded_context.rs contains NO inline find, soft-delete, or file-write logic — its only computation is JSON arg marshalling
    let bridge_path =
