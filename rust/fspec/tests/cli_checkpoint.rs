...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And the CLI bridge module rust/fspec/src/checkpoint.rs contains NO inline capture, index-write, or rendering logic — its only computation is JSON arg marshalling
...
fn scenario_checkpoint_help_is_byte_for_byte_identical_to_ts() {
    ...
    // @step And stdout is byte-for-byte identical to the fixture at rust/fspec/tests/fixtures/help/checkpoint.txt
    let fixture_path =
