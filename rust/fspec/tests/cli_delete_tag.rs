...
//! `rust/fspec-core/src/commands/delete_tag.rs` implementation
...
fn cli_delete_tag_help_output_matches_captured_typescript_fixture() {
    ...
    // @step And stdout matches the captured fixture at rust/fspec/tests/fixtures/help/delete-tag.txt
