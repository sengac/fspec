...
fn scenario_cli_default_output_prints_the_green_summary_line() {
    ...
    // @step When I run `./rust/target/release/fspec compare-implementations --tag @cli` from that workspace
...
fn scenario_cli_json_prints_2_space_json_envelope_to_stdout() {
    ...
    // @step When I run `./rust/target/release/fspec compare-implementations --tag @cli --json` from that workspace
...
fn scenario_cli_show_coverage_includes_deduplicated_coverage_file_paths() {
    ...
    // @step When I run `./rust/target/release/fspec compare-implementations --tag @cli --show-coverage --json` from that workspace
...
fn scenario_cli_exits_1_when_work_units_json_is_missing() {
    ...
    // @step When I run `./rust/target/release/fspec compare-implementations --tag @cli` from that directory
...
fn scenario_compare_implementations_help_is_byte_for_byte_identical() {
    ...
    // @step When I run `./rust/target/release/fspec compare-implementations --help` piped to non-TTY
    ...
    // @step And stdout matches the captured fixture at rust/fspec/tests/fixtures/help/compare-implementations.txt
