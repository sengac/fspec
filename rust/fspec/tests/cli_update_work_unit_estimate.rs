...
fn scenario_clap_exposes_estimate_help() {
    ...
    // @step When I run `./rust/target/release/fspec update-work-unit-estimate --help`
...
fn scenario_cli_sets_task_estimate_and_prints_success() {
    ...
    // @step When I run `./rust/target/release/fspec update-work-unit-estimate TASK-001 3`
...
fn scenario_cli_reports_invalid_estimate_on_stderr() {
    ...
    // @step When I run `./rust/target/release/fspec update-work-unit-estimate TASK-001 7`
