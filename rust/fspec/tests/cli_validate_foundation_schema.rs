...
fn cli_validates_a_valid_foundation_and_exits_0() {
    ...
    // @step When I run `./rust/target/release/fspec validate-foundation-schema` from that directory
...
fn clap_exposes_validate_foundation_schema_and_prints_help_byte_identical() {
    ...
    // @step When I run `./rust/target/release/fspec validate-foundation-schema --help` from a shell
