...
//! `rust/fspec-core/src/commands/update_tag.rs` implementation
...
fn cli_update_tag_help_output_matches_captured_typescript_fixture() {
    ...
    // @step And stdout matches the captured fixture at rust/fspec/tests/fixtures/help/update-tag.txt
