//! Themed CSS for the viewer — port of `src/server/templates/viewer-styles.ts`.
//!
//! Defines dark (default `:root`) and light (`:root.light-theme`) CSS variables,
//! the markdown content area, theme-toggle / font-size controls, code-block
//! cards with copy button and uppercase language badge, and light-theme Prism
//! token color overrides.

/// Full stylesheet emitted inside the page `<style>` block.
pub const STYLES: &str = r#"
    * { box-sizing: border-box; }
    ...
    .theme-toggle:hover { background-color: var(--control-hover-bg); }
    ...
    .font-size-button:hover:not(:disabled) { background-color: var(--control-hover-bg); }
    .font-size-button:disabled { opacity: 0.5; cursor: not-allowed; }
    .font-size-display {
      font-size: 0.875rem;
      min-width: 3rem;
      text-align: center;
    ...
    pre.code-block:hover .copy-button { opacity: 1; }
    ...
    pre.mermaid { background: transparent; text-align: center; margin: 1.5rem 0; }
    pre.mermaid svg { max-width: 100%; height: auto; display: block; margin: 0 auto; }
    table { border-collapse: collapse; }
    th, td { border: 1px solid var(--border-color); padding: 0.4rem 0.8rem; }
    img { max-width: 100%; }

    :root.light-theme .token.comment,
    :root.light-theme .token.prolog,
    :root.light-theme .token.doctype,
    :root.light-theme .token.cdata { color: #6a737d; }
    :root.light-theme .token.punctuation { color: #24292f; }
    ...
    :root.light-theme .token.deleted { color: #005cc5; }
    ...
    :root.light-theme .token.inserted { color: #032f62; }
    ...
    :root.light-theme .token.keyword { color: #d73a49; }
    :root.light-theme .token.function,
    :root.light-theme .token.class-name { color: #6f42c1; }
    :root.light-theme .token.regex,
    :root.light-theme .token.important,
    :root.light-theme .token.variable { color: #e36209; }
"#;
