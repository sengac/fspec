  ...
  examples: [
    {
      ...
      description: 'Restore deleted architecture note with ID 2',
      output:
    ...
    },
    {
      ...
      description: 'Restore multiple architecture notes at once (bulk restore)',
      output: '✓ Restored 3 architecture notes from AUTH-001',
    },
  ],
  notes: [
