  ...
  describe('Scenario: Display Kanban board showing all states', () => {
    it('should display columns for all states with work units', async () => {
      ...
      const workUnitsData = {
        ...
        workUnits: {
          'AUTH-001': { id: 'AUTH-001', title: 'Auth task', status: 'backlog', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-002': { id: 'AUTH-002', title: 'Auth spec', status: 'specifying', estimate: 8, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-003': { id: 'AUTH-003', title: 'Auth test', status: 'testing', estimate: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'DASH-001': { id: 'DASH-001', title: 'Dashboard', status: 'implementing', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'API-001': { id: 'API-001', title: 'API', status: 'validating', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'SEC-001': { id: 'SEC-001', title: 'Security', status: 'done', estimate: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
        },
        states: {
          backlog: ['AUTH-001'],
          specifying: ['AUTH-002'],
  ...
  describe('Scenario: Limit displayed work units per column with --limit option', () => {
    it('should limit displayed work units and show overflow indicator', async () => {
      ...
      const workUnitsData = {
        ...
        workUnits: {
          'AUTH-001': { id: 'AUTH-001', title: 'First', status: 'backlog', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-002': { id: 'AUTH-002', title: 'Second', status: 'backlog', estimate: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-003': { id: 'AUTH-003', title: 'Third', status: 'backlog', estimate: 8, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-004': { id: 'AUTH-004', title: 'Fourth', status: 'backlog', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-005': { id: 'AUTH-005', title: 'Fifth', status: 'backlog', estimate: 2, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
        },
        states: {
  ...
  describe('Scenario: Export Kanban board as JSON for programmatic access', () => {
    it('should export board data as valid JSON', async () => {
      ...
      const workUnitsData = {
        ...
        workUnits: {
          'AUTH-001': { id: 'AUTH-001', title: 'Backlog task', status: 'backlog', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'AUTH-002': { id: 'AUTH-002', title: 'Spec task', status: 'specifying', estimate: 8, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          'DASH-001': { id: 'DASH-001', title: 'Implementing task', status: 'implementing', estimate: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
        },
        states: {
          backlog: ['AUTH-001'],
          specifying: ['AUTH-002'],
