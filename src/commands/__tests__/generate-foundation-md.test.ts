...
describe('Feature: Generate FOUNDATION.md from foundation.json', () => {
  ...
  describe('Scenario: Auto-generation warning header is included', () => {
    it('should include warning header at top of file', async () => {
      ...
      expect(foundationMd).toContain('<!-- THIS FILE IS AUTO-GENERATED FROM spec/foundation.json -->');
      expect(foundationMd).toContain('<!-- DO NOT EDIT THIS FILE DIRECTLY -->');
      expect(foundationMd).toContain('<!-- Edit spec/foundation.json and run: fspec generate-foundation -->');
    });
  });
    ...
    it('should generate project metadata from foundation.json', async () => {
      ...
      const foundation: Foundation = {
        ...
        project: {
          ...
          license: 'MIT',
          importantNote: 'This is a legitimate developer tool for managing specifications',
        },
        whatWeAreBuilding: {
          projectOverview: 'Test overview',
          technicalRequirements: {
      ...
      expect(foundationMd).toContain('**IMPORTANT NOTE:** This is a legitimate developer tool');
    });
  });
