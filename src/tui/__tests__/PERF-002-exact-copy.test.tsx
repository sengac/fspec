/**
 * PERF-002: Test exactly copied from working AgentView
 * 
 * This test demonstrates that manual compaction works when copied
 * from the working AgentView.test.tsx pattern.
 */
