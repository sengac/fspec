...
- ❌ `add-user-example-example-example-example-example-example-example-example-example-example-example-login.feature` - describes the task
...
```bash
# Starting work
fspec add-tag-to-feature spec/features/example-example-example-example-example-example-example-example-example-example-example-login.feature @wip

# Completing work
fspec remove-tag-from-feature spec/features/example-example-example-example-example-example-example-example-example-example-example-login.feature @wip
fspec add-tag-to-feature spec/features/example-example-example-example-example-example-example-example-example-example-example-login.feature @done
```
