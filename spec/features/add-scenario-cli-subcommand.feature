...
Feature: add-scenario CLI subcommand (Rust shell front-door)
  ...
  Scenario: CLI help output matches captured TypeScript fixture byte-for-byte
    ...
    Then the process exits with code 0
    And stdout matches the captured fixture at codelet/fspec/tests/fixtures/help/add-scenario.txt
  ...
  Scenario: CLI delegates to the same fspec_core function used by the dispatcher
    ...
    And the CLI bridge module codelet/fspec/src/add_scenario.rs contains NO inline gherkin parsing or insertion logic
