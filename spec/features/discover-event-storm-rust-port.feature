...
Feature: Port discover-event-storm command to Rust
  """
  File layout: core impl rust/fspec-core/src/commands/discover_event_storm.rs (rewrite stub); CLI bridge rust/fspec/src/discover_event_storm.rs; help config rust/fspec-core/src/help/configs/discover_event_storm.rs; help fixture rust/fspec/tests/fixtures/help/discover-event-storm.txt; core test rust/fspec-core/tests/discover_event_storm.rs; CLI test rust/fspec/tests/cli_discover_event_storm.rs. Module already registered as a stub in commands/mod.rs (do not edit).
