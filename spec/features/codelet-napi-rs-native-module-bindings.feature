...
Feature: Codelet NAPI-RS Native Module Bindings
  """
  Uses NAPI-RS to create Node.js native bindings for rust's Rust crates. The codelet-napi crate wraps codelet-core, codelet-providers, and codelet-tools. ThreadsafeFunction enables streaming from Rust async runtime to Node.js event loop. TypeScript definitions auto-generated by napi-derive. Supports 6 platforms: darwin-arm64, darwin-x64, linux-arm64, linux-x64, win32-arm64, win32-x64.
  """
  ...
  Background: User Story
    ...
    I want to import rust's Rust AI agent functionality as a native Node.js module
