...
Feature: fspec add-external-system CLI subcommand
  ...
  Scenario: Help output matches the captured TS fixture
    ...
    And the stdout matches the canonical help fixture at codelet/fspec/tests/fixtures/help/add-external-system.txt
  ...
  Scenario: CLI delegates to the same fspec_core function used by the dispatcher
    ...
    And the CLI bridge module codelet/fspec/src/add_external_system.rs contains NO inline item construction, status guard, or file-write logic — its only computation is JSON arg marshalling
