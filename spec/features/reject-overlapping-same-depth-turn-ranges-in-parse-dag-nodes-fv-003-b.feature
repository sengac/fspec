...
Feature: Reject overlapping same-depth turn ranges in parse_dag_nodes (FV-003-b)
  """
  On completion, docs/FORMAL_VERIFICATION.md MUST be updated: (1) Remove FV-003-b row from Findings table at line 197. (2) Decrement limitation count in FV-003 row of Proofs status table at line 216. (3) Remove the limitation_parser_does_not_reject_overlap test from dag_node_proptest.test.rs.
