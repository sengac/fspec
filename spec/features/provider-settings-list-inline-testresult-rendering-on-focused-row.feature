...
Feature: Provider settings list: inline testResult rendering on focused row
  ...
  rust/fspec-tui/src/views/provider_settings/list_nav_render.rs only
  ...
  Tests target rust/fspec-tui/src/views/provider_settings/list_nav_render.rs
  ...
  Scenario: render_nav_items reads view.test_result inside the per-row paint loop
    Given I read the source of rust/fspec-tui/src/views/provider_settings/list_nav_render.rs
  ...
  Scenario: paint_test_result_decoration helper is owned exclusively by list_nav_render.rs
    ...
    And I read the source of rust/fspec-tui/src/views/provider_settings/row_render.rs
