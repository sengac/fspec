...
Feature: generate-coverage does not detect new scenarios in existing feature files
  ...
  # Example: REPRODUCTION: work-unit-dependency-management.feature has 42 scenarios, but .coverage file only has 39 scenario entries
  ...
  # Example: MISSING: Scenario 'Identify bottleneck work units blocking the most work' (line 501-518) NOT in coverage file
  Scenario: Scenario 'Identify bottleneck work units blocking the most work' (line 501-518) NOT in coverage file
    Given [precondition]
    When [action]
    Then [expected outcome]

  # Example: MISSING: Scenario 'Auto-suggest dependency relationships based on work unit metadata' (line 520-536) NOT in coverage file
  Scenario: Scenario 'Auto-suggest dependency relationships based on work unit metadata' (line 520-536) NOT in coverage file
    Given [precondition]
    When [action]
    Then [expected outcome]

  # Example: MISSING: Scenario 'Detect orphaned work units with no epic or dependencies' (line 538-553) NOT in coverage file
  Scenario: Scenario 'Detect orphaned work units with no epic or dependencies' (line 538-553) NOT in coverage file
    Given [precondition]
    When [action]
    Then [expected outcome]

  # Example: COMMAND RESULT: 'fspec generate-coverage' runs without error but does NOT add missing scenarios
  ...
  # Example: ERROR WHEN LINKING: 'fspec link-coverage work-unit-dependency-management --scenario "Identify bottleneck..."' fails with 'Scenario not found'
  ...
  # Example: FILE: spec/features/work-unit-dependency-management.feature - grep shows 42 scenarios: 'grep -c "^  Scenario:" spec/features/work-unit-dependency-management.feature' returns 42
  ...
  # Example: FILE: spec/features/work-unit-dependency-management.feature.coverage - only has 39 entries in scenarios array (verified by reading JSON)
  ...
  # Example: EXACT LINE: Feature file line 501: '@COV-046' tag, Scenario: 'Identify bottleneck work units blocking the most work' - MISSING from coverage
  ...
  # Example: EXACT LINE: Feature file line 520: '@COV-047' tag, Scenario: 'Auto-suggest dependency relationships based on work unit metadata' - MISSING from coverage
  ...
  # Example: EXACT LINE: Feature file line 538: '@COV-048' tag, Scenario: 'Detect orphaned work units with no epic or dependencies' - MISSING from coverage
  ...
  # Example: COMMAND TO REPRODUCE: 1) Add new scenario to existing .feature file 2) Run 'fspec generate-coverage' 3) Check .coverage file - new scenario NOT added 4) Try 'fspec link-coverage <feature> --scenario <name>' - ERROR: Scenario not found
