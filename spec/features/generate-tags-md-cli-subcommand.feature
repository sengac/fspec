...
Feature: fspec generate-tags-md CLI subcommand
  ...
  Scenario: Help output matches the captured TS fixture
    ...
    And the stdout matches the canonical help fixture at codelet/fspec/tests/fixtures/help/generate-tags-md.txt
  ...
  Scenario: CLI delegates to the same fspec_core function used by the dispatcher
    ...
    And the CLI bridge module codelet/fspec/src/generate_tags_md.rs contains NO inline markdown rendering, schema validation, or file-write logic — its only computation is JSON arg marshalling
