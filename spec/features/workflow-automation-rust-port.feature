...
Feature: Port workflow-automation command to Rust
  """
  File layout: core rust/fspec-core/src/commands/workflow_automation.rs (rewrite stub) single source of truth run(args_json, project_root); CLI bridge rust/fspec/src/workflow_automation.rs (positional action + work-unit-id, --event/--from-state); help config rust/fspec-core/src/help/configs/workflow_automation.rs; help fixture rust/fspec/tests/fixtures/help/workflow-automation.txt; integration test rust/fspec/tests/cli_workflow_automation.rs; core test rust/fspec-core/tests/workflow_automation.rs
  ...
  Background: User Story
    Given the workflow-automation command is ported to Rust in rust/fspec-core/src/commands/workflow_automation.rs
