...
Feature: fspec add-domain-event-to-foundation CLI subcommand
  ...
  Scenario: Help output matches the captured TS fixture
    ...
    And the stdout matches the canonical help fixture at codelet/fspec/tests/fixtures/help/add-domain-event-to-foundation.txt
  ...
  Scenario: CLI delegates to the same fspec_core function used by the dispatcher
    ...
    And the CLI bridge module codelet/fspec/src/add_domain_event_to_foundation.rs contains NO inline item construction, context lookup, or file-write logic — its only computation is JSON arg marshalling
