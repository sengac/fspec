...
Feature: Enter key on board bypasses Create Session dialog - no isolated option
  ...
  #   3. The Create Session dialog must show Normal/Isolated toggle options
  #
  # EXAMPLES:
  #   1. User selects work unit AUTH-001 with no attached session, presses Enter, Create Session dialog appears with Normal/Isolated toggle
