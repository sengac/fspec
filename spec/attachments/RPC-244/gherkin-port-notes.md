# RPC-244 — `list-feature-tags` — Gherkin Port Notes

**Category:** (C) Read/Query
**Master guide:** `spec/attachments/RPC-003/gherkin-porting-guide.md`

## Current TS Source
`src/commands/list-feature-tags.ts`

## Rust Port Plan
Parses one feature, lists `feat.tags`, optionally with categories (cross-reference tag registry).
...
- Category lookup is a separate, non-Gherkin concern.
