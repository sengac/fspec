...
```
spec/
├── CODEX-CLI.md                    # This file - specification process guide
...
1. **NO Markdown-Based Specifications**
   ...
   - Exception: FOUNDATION.md, TAGS.md, and CODEX-CLI.md are meta-documentation
...
- This makes failures highly visible in Codex CLI
...
This makes failures **highly visible** to AI agents in Codex CLI, ensuring they address issues before continuing.
