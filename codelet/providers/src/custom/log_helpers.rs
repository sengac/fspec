...
pub(crate) fn truncate_json_preview(value: &serde_json::Value, max_chars: usize) -> String {
    let s = serde_json::to_string(value).unwrap_or_else(|_| "<<serialize failed>>".to_string());
