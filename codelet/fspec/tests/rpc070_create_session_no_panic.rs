...
//! the other sync→async bridges in `codelet/sessions/src/handle_impl.rs`)
...
//!
//! The pre-existing tests in `codelet/sessions/tests/handle_impl.rs`
...
/// pattern. Mirrors `codelet/fspec/tests/common/mod.rs::strip_comments`
...
fn scenario_pre_existing_handle_impl_tests_still_pass() {
    ...
    //
    // The full assertion lives in codelet/sessions/tests/handle_impl.rs;
