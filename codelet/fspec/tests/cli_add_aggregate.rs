...
fn scenario_add_aggregate_help_matches_ts_fixture() {
    ...
    // @step And the stdout matches the canonical help fixture at codelet/fspec/tests/fixtures/help/add-aggregate.txt
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    assert!(
        bridge_path.exists(),
        "codelet/fspec/src/add_aggregate.rs must exist as the CLI bridge module; got missing: {}",
        bridge_path.display()
    );
