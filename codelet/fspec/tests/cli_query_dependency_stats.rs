...
fn scenario_clap_exposes_query_dependency_stats_with_help() {
    ...
    // @step When I run `./codelet/target/release/fspec query-dependency-stats --help` from a shell
...
fn scenario_cli_format_json_prints_all_ten_canonical_fields_against_empty_workspace() {
    ...
    // @step When I run `./codelet/target/release/fspec query-dependency-stats --format json` from that directory
...
fn scenario_cli_without_format_prints_nothing_to_stdout() {
    ...
    // @step When I run `./codelet/target/release/fspec query-dependency-stats` from that directory
...
fn scenario_cli_format_text_prints_nothing_to_stdout() {
    ...
    // @step When I run `./codelet/target/release/fspec query-dependency-stats --format text` from that directory
...
fn scenario_query_dependency_stats_help_matches_ts_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec query-dependency-stats --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("query-dependency-stats")
        .arg("--help")
    ...
    // @step Then stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/query-dependency-stats.txt
