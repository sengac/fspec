...
fn scenario_clap_exposes_list_checkpoints_with_flag_aware_help() {
    ...
    // @step When I run `./codelet/target/release/fspec list-checkpoints --help` from a shell
...
fn scenario_list_checkpoints_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec list-checkpoints --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("list-checkpoints")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/list-checkpoints.txt
...
fn scenario_missing_positional_argument_exits_non_zero() {
    ...
    // @step When I run `./codelet/target/release/fspec list-checkpoints` from a shell with NO positional argument
...
fn scenario_cli_against_empty_directory_prints_sentinel_and_no_git() {
    ...
    // @step When I run `./codelet/target/release/fspec list-checkpoints AUTH-001` from that directory
