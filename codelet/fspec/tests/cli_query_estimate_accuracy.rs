...
fn scenario_clap_exposes_query_estimate_accuracy_with_flag_aware_help() {
    ...
    // @step When I run `./codelet/target/release/fspec query-estimate-accuracy --help` from a shell
...
fn scenario_cli_against_empty_workspace_prints_empty_report_header() {
    ...
    // @step When I run `./codelet/target/release/fspec query-estimate-accuracy` from that directory
...
fn scenario_cli_text_output_renders_populated_by_story_points_section() {
    ...
    // @step When I run `./codelet/target/release/fspec query-estimate-accuracy`
    let (code, stdout, stderr) = run_qea(ws.path(), &[]);
...
fn scenario_cli_format_json_prints_pretty_printed_json() {
    ...
    // @step When I run `./codelet/target/release/fspec query-estimate-accuracy --format json`
...
fn scenario_query_estimate_accuracy_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec query-estimate-accuracy --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("query-estimate-accuracy")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/query-estimate-accuracy.txt
