...
fn scenario_help_output_matches_ts_fixture() {
    ...
    // @step And the stdout matches the canonical help fixture at codelet/fspec/tests/fixtures/help/add-foundation-bounded-context.txt
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And the CLI bridge module codelet/fspec/src/add_foundation_bounded_context.rs contains NO inline item construction, seeding, or file-write logic — its only computation is JSON arg marshalling
    let bridge_path =
