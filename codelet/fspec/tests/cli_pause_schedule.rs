...
fn scenario_cli_errors_and_exits_1_when_schedule_missing() {
    ...
    assert_eq!(code, 1, "fspec pause-schedule must exit 1 on error; got {code}");
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    write_schedules(ws_dispatch.path(), &one_shell_schedule("nightly-review", "active"));
    write_schedules(ws_cli.path(), &one_shell_schedule("nightly-review", "active"));
