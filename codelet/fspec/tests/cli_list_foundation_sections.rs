...
//! `codelet/fspec/src/main.rs` does not yet route `list-foundation-sections`,
...
fn scenario_list_foundation_sections_help_matches_ts_commander_default() {
    ...
    // @step When I run `./codelet/target/release/fspec list-foundation-sections --help` piped to non-TTY
    ...
    // (Fixture captured at codelet/fspec/tests/fixtures/help/list-foundation-sections.txt — 7 lines including final newline.)
