...
//! into `codelet/fspec/src/main.rs` are `#[ignore]`d until the
...
fn scenario_clap_exposes_list_scenario_tags_with_flag_aware_help() {
    ...
    // @step When I run `./codelet/target/release/fspec list-scenario-tags --help` from a shell
...
fn scenario_cli_prints_tag_list_and_exits_0() {
    ...
    // @step When I run `./codelet/target/release/fspec list-scenario-tags spec/features/user-login.feature "Login with valid credentials"`
