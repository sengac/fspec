...
fn scenario_cli_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step And stdout matches the captured fixture at codelet/fspec/tests/fixtures/help/update-step.txt
...
fn scenario_cli_delegates_to_same_fspec_core_function_as_dispatcher() {
    ...
    // @step And the CLI bridge module codelet/fspec/src/update_step.rs contains NO inline gherkin parsing or step-update logic
    let bridge_path = Path::new(env!("CARGO_MANIFEST_DIR")).join("src/update_step.rs");
    assert!(
        bridge_path.exists(),
        "codelet/fspec/src/update_step.rs must exist as the CLI bridge module"
    );
