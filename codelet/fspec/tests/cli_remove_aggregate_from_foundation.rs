...
fn scenario_clap_exposes_remove_aggregate_from_foundation_in_help() {
    ...
    // @step When I run `./codelet/target/release/fspec remove-aggregate-from-foundation --help`
...
fn scenario_cli_soft_deletes_aggregate_and_prints_success_message() {
    ...
    // @step When I run `./codelet/target/release/fspec remove-aggregate-from-foundation Sales Order`
...
fn scenario_cli_rejects_unknown_aggregate_with_exit_1() {
    ...
    // @step When I run `./codelet/target/release/fspec remove-aggregate-from-foundation Sales Ghost`
...
fn scenario_remove_aggregate_from_foundation_help_matches_ts_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec remove-aggregate-from-foundation --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("remove-aggregate-from-foundation")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/remove-aggregate-from-foundation.txt
