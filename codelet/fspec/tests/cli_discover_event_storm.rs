...
fn scenario_discover_event_storm_help_matches_ts_fixture() {
    ...
    // @step When I run `./codelet/target/release/fspec discover-event-storm --help` from a shell
...
fn scenario_cli_emits_guidance_for_specifying_unit_and_exits_0() {
    ...
    // @step When I run `./codelet/target/release/fspec discover-event-storm AUTH-001` from that directory
