...
fn scenario_clap_exposes_restore_architecture_note_with_two_positional_args_in_help() {
    ...
    // @step When I run `./codelet/target/release/fspec restore-architecture-note --help`
...
fn scenario_cli_restores_architecture_note_and_prints_success_line() {
    ...
    // @step When I run `./codelet/target/release/fspec restore-architecture-note AUTH-001 0`
...
fn scenario_cli_rejects_unknown_note_id_with_exit_1_and_error_prefix() {
    ...
    // @step When I run `./codelet/target/release/fspec restore-architecture-note AUTH-001 5`
...
fn scenario_cli_rejects_unknown_work_unit_with_exit_1_and_error_prefix() {
    ...
    // @step When I run `./codelet/target/release/fspec restore-architecture-note AUTH-999 0`
...
fn scenario_restore_architecture_note_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec restore-architecture-note --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("restore-architecture-note")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/restore-architecture-note.txt
