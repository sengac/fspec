...
fn cli_validates_a_single_valid_file_and_exits_0() {
    ...
    // @step When I run `./codelet/target/release/fspec validate spec/features/login.feature` from that directory
...
fn cli_exits_1_against_a_syntactically_broken_file() {
    ...
    // @step When I run `./codelet/target/release/fspec validate spec/features/broken.feature` from that directory
...
fn cli_exits_2_when_no_feature_files_are_found() {
    ...
    // @step When I run `./codelet/target/release/fspec validate` from that directory
...
fn clap_exposes_validate_and_prints_help_byte_identical() {
    ...
    // @step When I run `./codelet/target/release/fspec validate --help` from a shell
