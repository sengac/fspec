...
fn scenario_list_epics_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec list-epics --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("list-epics")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/list-epics.txt
