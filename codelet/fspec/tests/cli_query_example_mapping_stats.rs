...
fn scenario_clap_exposes_query_example_mapping_stats_with_help() {
    ...
    // @step When I run `./codelet/target/release/fspec query-example-mapping-stats --help` from a shell
...
fn scenario_cli_format_json_prints_canonical_empty_stats() {
    ...
    // @step When I run `./codelet/target/release/fspec query-example-mapping-stats --format json` from that directory
...
fn scenario_cli_without_format_prints_nothing_to_stdout() {
    ...
    // @step When I run `./codelet/target/release/fspec query-example-mapping-stats` from that directory
...
fn scenario_cli_format_text_prints_nothing_to_stdout() {
    ...
    // @step When I run `./codelet/target/release/fspec query-example-mapping-stats --format text` from that directory
...
fn scenario_query_example_mapping_stats_help_matches_ts_reference() {
    // @step Given the fspec Rust binary at codelet/target/release/fspec has been compiled
    // @step When I run `./codelet/target/release/fspec query-example-mapping-stats --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("query-example-mapping-stats")
        .arg("--help")
    ...
    // @step Then stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/query-example-mapping-stats.txt
