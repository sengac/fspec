...
fn scenario_clap_exposes_delete_epic_with_arg_and_force_flag() {
    ...
    // @step When I run `./codelet/target/release/fspec delete-epic --help`
...
fn scenario_cli_deletes_existing_epic_and_prints_success_line() {
    ...
    // @step When I run `./codelet/target/release/fspec delete-epic auth`
...
fn scenario_cli_accepts_force_flag_without_changing_behaviour() {
    ...
    // @step When I run `./codelet/target/release/fspec delete-epic auth --force`
...
fn scenario_cli_exits_1_when_epic_does_not_exist() {
    ...
    // @step When I run `./codelet/target/release/fspec delete-epic missing`
...
fn scenario_delete_epic_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec delete-epic --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("delete-epic")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/delete-epic.txt
