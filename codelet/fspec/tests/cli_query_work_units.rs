...
fn scenario_standalone_fspec_binary_exposes_query_work_units_as_a_clap_subcommand() {
    ...
    // @step When I run `./codelet/target/release/fspec query-work-units --help` from a shell
...
fn scenario_cli_tag_filter_matches_dispatcher_behavior() {
    ...
    // @step When I run `./codelet/target/release/fspec query-work-units --tag=@cli --format=json`
...
fn scenario_cli_exits_1_and_writes_to_stderr_when_work_units_json_missing() {
    ...
    // @step When I run `./codelet/target/release/fspec query-work-units` from that directory
...
fn scenario_query_work_units_help_matches_ts_format_command_help_reference_fixture() {
    ...
    // @step When I run `./codelet/target/release/fspec query-work-units --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("query-work-units")
        .arg("--help")
    ...
    // @step Then stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/query-work-units.txt
