...
fn scenario_clap_exposes_create_epic_with_args_and_description_flag() {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic --help`
...
fn scenario_cli_creates_minimal_epic_and_prints_success_block() {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic auth Authentication`
...
fn scenario_cli_creates_epic_with_description_flag() {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic auth Authentication -d "Login features"`
...
fn scenario_cli_rejects_invalid_epic_id_with_exit_1() {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic INVALID Authentication`
...
fn scenario_cli_rejects_duplicate_epic_with_exit_1() {
  ...
  "epics": {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic auth NewTitle`
...
fn scenario_create_epic_help_matches_ts_formatcommandhelp_reference() {
    ...
    // @step When I run `./codelet/target/release/fspec create-epic --help` piped to non-TTY
    let output = Command::new(fspec_bin())
        .arg("create-epic")
        .arg("--help")
    ...
    // @step And stdout is byte-for-byte identical to the fixture at codelet/fspec/tests/fixtures/help/create-epic.txt
