...
fn core_delete_session_lifts_napi_implementation() {
    ...
    // @step And the NAPI export persistence_delete_session from codelet/napi/src/persistence/napi_bindings.rs is a one-line delegate to codelet_core::persistence::delete_session
