...
fn header_widget_modules_exist_as_separate_files() {
    // @step Given the codelet/fspec-tui crate after RPC-015 lands
...
fn new_and_modified_board_modules_stay_under_300_lines() {
    // @step Given the directory codelet/fspec-tui/src/views/board/ plus the views/board.rs orchestrator
...
fn checkpoint_counts_shared_type_lives_in_rpc_types() {
    // @step Given codelet/rpc-types/src/lib.rs after RPC-015 lands
...
fn fspec_service_trait_gains_the_checkpoint_counts_rpc_method() {
    // @step Given codelet/rpc/src/lib.rs after RPC-015 lands
...
fn fspec_backend_trait_gains_the_checkpoint_counts_method() {
    // @step Given codelet/fspec-tui/src/transport/mod.rs after RPC-015 lands
...
fn action_enum_gains_checkpointcountsloaded_variant() {
    // @step Given codelet/fspec-tui/src/components/mod.rs after RPC-015 lands
...
fn napi_surface_exposes_the_additive_count_checkpoints_export() {
    // @step Given codelet/napi/src/git.rs after RPC-015 lands
    ...
    assert!(
        ...
        "codelet/napi/src/git.rs must export `pub fn count_checkpoints`"
    );
...
fn rpc013_and_rpc014_invariants_preserved() {
    // @step Given codelet/fspec-tui/src/views/navigator.rs after RPC-015 lands
