...
fn fspec_backend_trait_declares_search_files() {
    // @step Given codelet/fspec-tui/src/transport/mod.rs after RPC-020 lands
...
fn both_transports_implement_search_files() {
    ...
    // @step Then codelet/fspec-tui/src/transport/embedded.rs contains the substring "async fn search_files"
    assert!(embedded.contains("async fn search_files"));
    // @step And codelet/fspec-tui/src/transport/websocket.rs contains the substring "async fn search_files"
...
fn agent_view_orchestrator_owns_the_new_popup_fields() {
    // @step Given codelet/fspec-tui/src/views/agent.rs after RPC-020 lands
...
fn action_enum_gains_three_new_variants() {
    // @step Given codelet/fspec-tui/src/components/mod.rs after RPC-020 lands
...
fn every_file_under_views_agent_stays_under_300_lines() {
    // @step Given the directory codelet/fspec-tui/src/views/agent/ plus the views/agent.rs orchestrator
...
fn views_do_not_directly_import_forbidden_crates() {
    // @step Given the directory codelet/fspec-tui/src/views/ (including views/agent/) after RPC-020 lands
