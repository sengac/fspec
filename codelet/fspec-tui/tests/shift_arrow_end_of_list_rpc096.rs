...
fn cycle_session_is_removed_from_public_api() {
    ...
    // @step And the file has fewer than 300 lines, OR navigate_next/navigate_prev live in the sibling module codelet/fspec-tui/src/store/agent_view/navigation.rs
