...
fn test_compact_messages_removed_from_session() {
    // @step Given Session in codelet/cli/src/session/mod.rs has a compact_messages() method
...
fn test_downstream_test_files_deleted() {
    ...
    // @step Then codelet/core/tests/llm_anchor_integration_test.rs no longer exists
    // @step And codelet/core/tests/retry_llm_summary_test.rs no longer exists
    // @step And codelet/core/tests/compaction_anchor_detection_test.rs no longer exists
    // @step And codelet/cli/tests/context_compaction_fix_test.rs no longer exists
    // @step And codelet/cli/tests/manual_compaction_command_test.rs no longer exists
    // @step And codelet/napi/tests/compaction_to_anchor_flow_test.rs no longer exists
    // @step And codelet/napi/tests/anchor_persistence_test.rs no longer exists
    // @step And codelet/napi/tests/anchor_persistence_layer_test.rs no longer exists
    // @step And codelet/napi/tests/anchor_napi_layer_test.rs no longer exists
    // @step And codelet/napi/tests/session_resume_anchor_test.rs no longer exists
    // Verified by: cargo build succeeding without these files
}
