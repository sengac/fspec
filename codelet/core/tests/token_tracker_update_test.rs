...
fn test_update_from_usage_matches_original_pattern() {
    ...
    assert_eq!(
        tracker_new.cumulative_billed_input,
        tracker_old.cumulative_billed_input
    );
    assert_eq!(
        tracker_new.cumulative_billed_output,
        tracker_old.cumulative_billed_output
    );
    assert_eq!(
        tracker_new.cache_read_input_tokens,
        tracker_old.cache_read_input_tokens
    );
    assert_eq!(
        tracker_new.cache_creation_input_tokens,
        tracker_old.cache_creation_input_tokens
    );
}
