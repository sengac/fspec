//! `update-work-unit` help configuration — Rust port of
//! `src/commands/update-work-unit-help.ts`.
//!
...
const PATTERNS: &[CommonPatternEntry] = &[
...
const EXAMPLES: &[CommandExample] = &[
    CommandExample {
        ...
        description: Some("Update work unit title"),
        output: Some("✓ Work unit AUTH-001 updated successfully"),
    },
    CommandExample {
        command:
            "fspec update-work-unit AUTH-001 --description \"Implement OAuth 2.0 authentication flow\"",
        description: Some("Update work unit description"),
        output: Some("✓ Work unit AUTH-001 updated successfully"),
    },
    CommandExample {
        command: "fspec update-work-unit AUTH-001 --epic AUTH",
        description: Some("Move work unit to different epic"),
        output: Some("✓ Work unit AUTH-001 updated successfully"),
    },
    CommandExample {
        command: "fspec update-work-unit AUTH-002 --parent AUTH-001",
        description: Some("Set parent-child relationship"),
        output: Some("✓ Work unit AUTH-002 updated successfully"),
    },
    CommandExample {
        command:
            "fspec update-work-unit AUTH-001 --title \"New title\" --description \"New description\" --epic API",
        description: Some("Update multiple fields at once"),
        output: Some("✓ Work unit AUTH-001 updated successfully"),
    },
];
...
pub const CONFIG: CommandHelpConfig = CommandHelpConfig {
    ...
    usage: Some("fspec update-work-unit <workUnitId> [options]"),
    arguments: ARGS,
    options: OPTS,
    examples: EXAMPLES,
    related_commands: RELATED,
    when_to_use: Some("Use this command to modify work unit metadata after creation. Common use cases: refining title/description, changing epic association, or restructuring parent-child relationships. NOTE: Work unit type (story/bug/task) is immutable and cannot be changed."),
    when_not_to_use: None,
    prerequisites: &["Work unit must exist in spec/work-units.json"],
    common_patterns: PATTERNS,
    typical_workflow: Some("1. View current metadata: fspec show-work-unit <workUnitId> → 2. Update fields: fspec update-work-unit <workUnitId> --title \"New title\" → 3. Verify changes: fspec show-work-unit <workUnitId>"),
