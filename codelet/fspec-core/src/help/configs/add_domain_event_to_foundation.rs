//! `add-domain-event-to-foundation` help configuration — Rust port of
//! `src/commands/add-domain-event-to-foundation-help.ts` (RPC-180).
//!
//! Byte-for-byte parity with
//! `node dist/index.js add-domain-event-to-foundation --help`.
//! Captured fixture:
//! `codelet/fspec/tests/fixtures/help/add-domain-event-to-foundation.txt`.
...
const COMMON_PATTERNS: &[CommonPatternEntry] = &[
    ...
    CommonPatternEntry::Bullet("Use descriptions to document business significance"),
];

const EXAMPLES: &[CommandExample] = &[
    CommandExample {
        command: "fspec add-domain-event-to-foundation \"Work Management\" \"WorkUnitCreated\"",
        description: Some("Add WorkUnitCreated event to Work Management bounded context"),
        output: Some(
    ...
    CommandExample {
        ...
        description: Some("Add event with description"),
        output: Some(
    ...
    CommandExample {
        ...
        description: Some("Add UserLoggedIn event to Identity bounded context"),
        output: Some("✓ Added domain event \"UserLoggedIn\" to \"Identity\" bounded context"),
    },
];
...
pub const CONFIG: CommandHelpConfig = CommandHelpConfig {
    ...
    description: "Add a domain event to a foundation bounded context in Big Picture Event Storm",
    usage: Some(
