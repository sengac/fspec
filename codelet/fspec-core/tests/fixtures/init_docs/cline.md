...
```
spec/
├── CLINE.md                    # This file - specification process guide
...
1. **NO Markdown-Based Specifications**
   ...
   - Exception: FOUNDATION.md, TAGS.md, and CLINE.md are meta-documentation
...
- This makes failures highly visible in Cline
...
This makes failures **highly visible** to AI agents in Cline, ensuring they address issues before continuing.
