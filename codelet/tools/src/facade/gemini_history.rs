...
impl TurnCompletionFacade for GeminiTurnCompletionFacade {
    ...
    fn needs_continuation(&self, response_text: &str, messages: &[Message]) -> bool {
        ...
        response_empty && after_tool_result
    }

    fn continuation_prompt(&self) -> &'static str {
        // Simple continuation prompt that works well with Gemini models.
...
impl TurnCompletionFacade for DefaultTurnCompletionFacade {
    ...
    fn needs_continuation(&self, _response_text: &str, _messages: &[Message]) -> bool {
        false
    }

    fn continuation_prompt(&self) -> &'static str {
        "" // Never used since needs_continuation always returns false
    }
}
...
mod tests {
    ...
    // =========================================================================
    // Scenario: Turn completion - needs continuation detection
    // =========================================================================
