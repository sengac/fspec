...
//
// RPC-421: compact_session (BOTH twins — codelet/sessions/src/handle_impl.rs
// and codelet/napi/src/session_bindings.rs session_compact) must stop shipping
...
//
// The plain-CLI REPL (codelet/cli/src/interactive/repl_loop.rs) is the third
