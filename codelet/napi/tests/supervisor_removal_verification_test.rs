...
mod supervisor_removal_verification {
    ...
    mod no_references_remain {
        ...
        fn test_no_supervisor_references_in_source() {
            ...
            // @step When I search for supervisor_agent_loop in codelet/napi/src/
            // grep should find zero matches

            // @step And I search for ObservationBuffer in codelet/napi/src/
            // grep should find zero matches

            // @step And I search for SupervisorInput in codelet/napi/src/
            // grep should find zero matches

            // @step And I search for format_evaluation_prompt in codelet/napi/src/
            // grep should find zero matches

            // @step And I search for SupervisorRole in codelet/napi/src/
            // grep should find zero matches
