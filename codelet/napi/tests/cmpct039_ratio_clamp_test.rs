...
// codelet/cli/src/interactive_helpers.rs must clamp its result to [0.0, 1.0]
...
/// pattern from codelet/sessions/tests/rpc418_compact_session.rs.
...
// loop). This is the producer at codelet/sessions/src/handle_impl.rs that
